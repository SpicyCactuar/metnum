...
write(data_2005, "outputR/data_2005.in", ncolumns = 1)
write(data_2006, "outputR/data_2006.in", ncolumns = 1)
write(data_2007, "outputR/data_2007.in", ncolumns = 1)
write(data_2008, "outputR/data_2008.in", ncolumns = 1)

data_0_500 <- from_db("select count(*) as Count, year
from ontime where (distance BETWEEN 0 and 500) and (year = '2005' or year = '2006' or year = '2007' or year = '2008')
group by year")

data_501_1000 <- from_db("select count(*) as Count, year
from ontime where (distance BETWEEN 501 and 1000) and (year = '2005' or year = '2006' or year = '2007' or year = '2008')
group by year")

data_1001_1500 <- from_db("select count(*) as Count, year
from ontime where (distance BETWEEN 1001 and 1500) and (year = '2005' or year = '2006' or year = '2007' or year = '2008')
group by year")

data_1501_2000 <- from_db("select count(*) as Count, year
from ontime where (distance BETWEEN 1501 and 2000) and (year = '2005' or year = '2006' or year = '2007' or year = '2008')
group by year")

data_2001_2500 <- from_db("select count(*) as Count, year
from ontime where (distance BETWEEN 2001 and 2500) and (year = '2005' or year = '2006' or year = '2007' or year = '2008')
group by year")

data_2501_3000 <- from_db("select count(*) as Count, year
from ontime where (distance BETWEEN 2501 and 3000) and (year = '2005' or year = '2006' or year = '2007' or year = '2008')
group by year")

data_3001_3500 <- from_db("select count(*) as Count, year
from ontime where (distance BETWEEN 3001 and 3500) and (year = '2005' or year = '2006' or year = '2007' or year = '2008')
group by year")

data_3501_4000 <- from_db("select count(*) as Count, year
from ontime where (distance BETWEEN 3501 and 4000) and (year = '2005' or year = '2006' or year = '2007' or year = '2008')
group by year")

data_4001_4500 <- from_db("select count(*) as Count, year
from ontime where (distance BETWEEN 4001 and 4500) and (year = '2005' or year = '2006' or year = '2007' or year = '2008')
group by year")

data_4501_5000 <- from_db("select count(*) as Count, year
from ontime where (distance BETWEEN 4501 and 5000) and (year = '2005' or year = '2006' or year = '2007' or year = '2008')
group by year")

data_diverted_0_500 <- from_db("select count(*) as Count, year
from ontime where (distance BETWEEN 0 and 500) and (diverted = 1) and (year = '2005' or year = '2006' or year = '2007' or year = '2008')
group by year")

data_diverted_501_1000 <- from_db("select count(*) as Count, year
from ontime where (distance BETWEEN 501 and 1000) and (diverted = 1) and (year = '2005' or year = '2006' or year = '2007' or year = '2008')
group by year")

data_diverted_1001_1500 <- from_db("select count(*) as Count, year
from ontime where (distance BETWEEN 1001 and 1500) and (diverted = 1) and (year = '2005' or year = '2006' or year = '2007' or year = '2008')
group by year")

data_diverted_1501_2000 <- from_db("select count(*) as Count, year
from ontime where (distance BETWEEN 1501 and 2000) and (diverted = 1) and (year = '2005' or year = '2006' or year = '2007' or year = '2008')
group by year")

data_diverted_2001_2500 <- from_db("select count(*) as Count, year
from ontime where (distance BETWEEN 2001 and 2500) and (diverted = 1) and (year = '2005' or year = '2006' or year = '2007' or year = '2008')
group by year")

data_diverted_2501_3000 <- from_db("select count(*) as Count, year
from ontime where (distance BETWEEN 2501 and 3000) and (diverted = 1) and (year = '2005' or year = '2006' or year = '2007' or year = '2008')
group by year")

data_diverted_3001_3500 <- from_db("select count(*) as Count, year
from ontime where (distance BETWEEN 3001 and 3500) and (diverted = 1) and (year = '2005' or year = '2006' or year = '2007' or year = '2008')
group by year")

data_diverted_3501_4000 <- from_db("select count(*) as Count, year
from ontime where (distance BETWEEN 3501 and 4000) and (diverted = 1) and (year = '2005' or year = '2006' or year = '2007' or year = '2008')
group by year")

data_diverted_4001_4500 <- from_db("select count(*) as Count, year
from ontime where (distance BETWEEN 4001 and 4500) and (diverted = 1) and (year = '2005' or year = '2006' or year = '2007' or year = '2008')
group by year")

data_diverted_4501_5000 <- from_db("select count(*) as Count, year
from ontime where (distance BETWEEN 4501 and 5000) and (diverted = 1) and (year = '2005' or year = '2006' or year = '2007' or year = '2008')
group by year")
